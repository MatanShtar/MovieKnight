...
- [x] ** Step 1: The Chopping Block (chopping.html):** Design and build the UI where users are presented with two movies at a time and must eliminate one until only a single winner remains.
